    ...
    <div className='homeimage'>
      <h1>About PigmentWay</h1>
        ...
        <p>Pigments were produced on a larger scale by the Egyptians and the Chinese. Earth colours were cleaned and washed, increasing their strength and purity, and new pigments appeared from minerals such as malachite, azurite and cinnabar – prized as the first known bright red. Egyptian blue – a blue glass made from sand and copper which was ground into a powder – was first produced around 3000 BC.
           ...
           Tyrian purple came to signify power and wealth and was used by both the Greeks and the Romans. It was complicated to make,  involving using the mucus from thousands of murex snails, and cost a fortune. The Greeks also manufactured white lead, the first fully opaque white – used to make flake white and Cremnitz white – which involved stacking lead strips in a confined space among vinegar and animal dung. Nice pigment, not so nice smell.</p>
        <ul>
